...
#python ej_04_Embeddings.py -lr 1e-5 -e 10 -ed 75  -bs 64 -nn 25		# Mas epocas
...
#python ej_04_Embeddings.py -lr 1e-4 -e 10 -ed 75  -bs 64 -nn 25		# Mas epocas
...
#python ej_04_Embeddings.py -lr 1e-3 -e 10 -ed 75  -bs 64 -nn 25		# Overfitting
