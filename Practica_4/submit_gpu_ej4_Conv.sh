...
python ej_04_Conv1D.py -lr 1e-3 -e 200 -bs 256 -ed 50 -do 0.2
python ej_04_Conv1D.py -lr 1e-3 -e 200 -bs 256 -ed 50 -do 0.4
python ej_04_Conv1D.py -lr 1e-3 -e 200 -bs 256 -ed 50 -do 0.6
# python ej_04_Conv1D.py -lr 1e-3 -e 20 -bs 256 -ed 50 -do 0.8

python ej_04_Conv1D.py -lr 1e-4 -e 200 -bs 256 -ed 50 -do 0.2
python ej_04_Conv1D.py -lr 1e-4 -e 200 -bs 256 -ed 50 -do 0.4
python ej_04_Conv1D.py -lr 1e-4 -e 200 -bs 256 -ed 50 -do 0.6
# python ej_04_Conv1D.py -lr 1e-4 -e 20 -bs 256 -ed 50 -do 0.8

python ej_04_Conv1D.py -lr 1e-5 -e 200 -bs 256 -ed 50 -do 0.2
python ej_04_Conv1D.py -lr 1e-5 -e 200 -bs 256 -ed 50 -do 0.4
python ej_04_Conv1D.py -lr 1e-5 -e 200 -bs 256 -ed 50 -do 0.6    # Mas epocas
