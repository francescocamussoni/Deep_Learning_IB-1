...
model.save(os.path.join(data_folder, '2_model_XOR_B.h5'))
np.save(os.path.join(data_folder, '2_history_XOR_B.npy'), history.history)
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig(os.path.join(img_folder, '2_Loss_XOR_B.pdf'),
            format="pdf",
            bbox_inches="tight")
plt.close()
...
plt.legend(loc='best')
plt.tight_layout()
plt.savefig(os.path.join(img_folder, '2_Acc_XOR_B.pdf'),
            format="pdf",
            bbox_inches="tight")
plt.close()