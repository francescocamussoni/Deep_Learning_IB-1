...
# # plt.axis("equal")
# plt.savefig("Figuras/1.pdf", format="pdf", bbox_inches="tight")
# plt.show()
...
plt.tight_layout()
# plt.axis("equal")
plt.savefig("Figuras/2_Loss.pdf", format="pdf", bbox_inches="tight")
plt.show()
...
plt.tight_layout()
# plt.axis("equal")
plt.savefig("Figuras/2_Acc.pdf", format="pdf", bbox_inches="tight")
plt.show()
